...
public class PracticeJdbcApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<Object[]> splitNames = Arrays.asList("fname1 lname1", "fname2 lname2", "fname3 lname3")
        ...
        log.info("Querying for customer records where first_name = 'fname1':");

        jdbcTemplate.query("SELECT id, first_name, last_name FROM customers WHERE first_name = ?",
                new Object[] {"fname1"},(rs, rowNum) -> new Customer(rs.getLong("id"),
